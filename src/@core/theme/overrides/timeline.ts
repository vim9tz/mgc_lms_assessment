...
const timeline: Components<Theme> = {
  // TimelineDot override — from @mui/lab, not recognized by default MUI types
  /** @ts-expect-error MuiTimelineDot is a lab component and not typed in MUI core */
  MuiTimelineDot: {
    styleOverrides: {
      root: ({ theme }: any) => ({
