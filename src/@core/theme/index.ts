...
const nunito_sans = Nunito_Sans({ subsets: ['latin'], weight: ['200', '300', '400', '500', '600', '700', '800', '900', '1000'] })
const catamaran = Catamaran({ subsets: ['latin'], weight: ['200', '300', '400', '500', '600', '700', '800', '900'] })
...
const theme = (settings: Settings, mode: SystemMode, direction: Theme['direction']): Theme => {
  return {
    ...
    typography: typography(catamaran.style.fontFamily),
